...
# compute pvfb
x = 65
print(f"PVBT({pvfb_retirement.y}, {pvfb_retirement.x}, {pvfb_retirement.age_of_term_cost}|{x})={pvfb_retirement.pvfb(x=x)}")
print(f"PVBT({pvfb_retirement.y}, {pvfb_retirement.x}, {pvfb_retirement.age_of_term_cost}|{pvfb_retirement.x})={pvfb_retirement.pvfb_x()}")
