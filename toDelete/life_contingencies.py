...
def tqxn(mt, x, n, t):
    ...
    return tpx(mt, x, n) * tqx(mt, x + n, t)
...
def taaxn(mt, x, t, n, m=1):
    return aaxn(mt, x + t, n, m=1) * nEx(mt, x, t)


def taxn(mt, x, t, n, m=1):
    return axn(mt, x + t, n, m=1) * nEx(mt, x, t)
...
def taax(mt, x, t, m=1):
    ...
    return mt.Nx[x + t] / mt.Dx[x] - ((float(m - 1) / float(m * 2)) * nEx(mt, x, t))
